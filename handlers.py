#Данный список хендлеров не актуален, актуальные хендлеры хранятся в Nikita_handler
...
# @router.message(user_states.waiting_for_name)
...
# @router.message(user_states.waiting_for_description)
...
# @router.message(user_states.waiting_for_price)
...
# @router.message(user_states.waiting_for_amount)
